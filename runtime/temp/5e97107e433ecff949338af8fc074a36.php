<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"D:\www\zx18_News\Day_06\code\tp5\public/../application/index\view\category\index.html";i:1530080708;s:72:"D:\www\zx18_News\Day_06\code\tp5\application\index\view\public\base.html";i:1529545003;s:74:"D:\www\zx18_News\Day_06\code\tp5\application\index\view\public\header.html";i:1530062964;s:74:"D:\www\zx18_News\Day_06\code\tp5\application\index\view\public\footer.html";i:1530067666;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
  ...
  <div id="slide" class="carousel slide" style="width: 100%;height: 300px;" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item <?php if($key == 0): ?>active<?php endif; ?>">
        ...
        <img src="/zx18_News/Day_06/code/tp5/public/static/upload/<?php echo $vo['image']; ?>" style="width: 100%; height: 300px" alt="<?php echo $vo['title']; ?>">
        </a>
      </div>
      	<?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
	...
	<div class="panel panel-info" style="height: 320px;">
		...
		<div class="panel-body" style="padding: 0;">
		 <ul class="list-group" style="margin-bottom: 0;">
		 	<?php if(is_array($news[$vo['id']]) || $news[$vo['id']] instanceof \think\Collection || $news[$vo['id']] instanceof \think\Paginator): $i = 0; $__LIST__ = $news[$vo['id']];if( count($__LIST__)==0 ) : echo "暂时没有内容" ;else: foreach($__LIST__ as $key=>$vvo): $mod = ($i % 2 );++$i;?>
		 	<li class="list-group-item">
...
<?php endforeach; endif; else: echo "" ;endif; ?>
  ...
  <div class="container">
    ...
    <script src="/zx18_News/Day_06/code/tp5/public/static/js/jquery-3.3.1.js"></script>
    <script src="/zx18_News/Day_06/code/tp5/public/static/bootstrap/js/bootstrap.js"></script>
