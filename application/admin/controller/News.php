	...
	public function doAdd() {
		...
		if (!empty($file)) {
			...
			if ($info) {
				...
				$this->error($file->getError(), url('admin/news/add'));
			}
		}
		...
		if ($res) {
			...
			$this->error('添加失败', url('admin/news/add'));
		}
	}
	...
	public function doEdit() {
		...
		if (!empty($file)) {
			...
			if ($info) {
				...
				$this->error($file->getError(), url('admin/news/edit', ['id' => $id]));
			}
		}
		...
		if ($res) {
			$this->success('保存成功', url('admin/news/index'));
		} else {
			$this->error('保存失败', url('admin/news/edit', ['id' => $id]));
		}
	}
